...
def smartphone3() -> Smartphone:
    return Smartphone("Xiaomi Redmi Note 11", "1024GB, Синий", 31000.0,
...
@pytest.fixture
def category_smartphones() -> Category:
    return Category("Смартфоны", "Высокотехнологичные смартфоны",
                    [smartphone1, smartphone2])

@pytest.fixture
def category_grass() -> Category:
